CREATE TABLE [dbo].[NPA_IntegrationDetails_STDAcctsAsstCatg_30June2024] (
  ...
  [SEC_PROVPER_OLD] [varchar](100) NULL,
  [UNSEC_PROVPER_OLD] [varchar](100) NULL
)
ON [PRIMARY]
TEXTIMAGE_ON [PRIMARY]
GO

CREATE CLUSTERED INDEX [NPA_IntegrationDetailsxyz_Teamp_IX]
  ON [dbo].[NPA_IntegrationDetails_STDAcctsAsstCatg_30June2024] ([NCIF_Id], [CustomerId], [CustomerACID])
  ON [PRIMARY]
GO

CREATE INDEX [NPA_IntegrationDetailsxyz_temp_NON_IX]
  ON [dbo].[NPA_IntegrationDetails_STDAcctsAsstCatg_30June2024] ([EffectiveFromTimeKey], [EffectiveToTimeKey], [AC_AssetClassAlt_Key], [ProvisionAlt_Key], [SrcSysAlt_Key], [SecuredFlag], [IsFunded])
  ON [PRIMARY]
GO