CREATE TABLE [dbo].[NPA_IntegrationDetails_MONTH_END_DATA_JFM_2022] (
...
CREATE CLUSTERED INDEX [NPA_IntegrationDetails_JFM2022_IX]
  ON [dbo].[NPA_IntegrationDetails_MONTH_END_DATA_JFM_2022] ([NCIF_Id], [CustomerId], [CustomerACID])
  WITH (PAD_INDEX = ON, FILLFACTOR = 80)
  ON [PRIMARY]
GO

CREATE INDEX [NPA_IntegrationDetails_JFM2022_NON_IX]
  ON [dbo].[NPA_IntegrationDetails_MONTH_END_DATA_JFM_2022] ([EffectiveFromTimeKey], [EffectiveToTimeKey], [AC_AssetClassAlt_Key], [ProvisionAlt_Key], [SrcSysAlt_Key], [SecuredFlag], [IsFunded])
  WITH (PAD_INDEX = ON, FILLFACTOR = 80)
  ON [PRIMARY]
GO