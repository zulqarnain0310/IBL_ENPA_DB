CREATE TABLE [CURDAT].[AdvSecurityDetail] (
  ...
  [RefCustomer_CIF] [varchar](20) NULL,
...
CREATE CLUSTERED INDEX [AdvSecurityDetail_IX]
  ON [CURDAT].[AdvSecurityDetail] ([ENTITYKEY])
  ON [PRIMARY]
GO

CREATE INDEX [AdvSecurityDetail_NONIX]
  ON [CURDAT].[AdvSecurityDetail] ([EffectiveFromTimeKey], [EffectiveToTimeKey], [RefSystemAcId], [RefCustomerId], [RefCustomer_CIF], [CollateralID], [SecurityEntityID])
  ON [PRIMARY]
GO