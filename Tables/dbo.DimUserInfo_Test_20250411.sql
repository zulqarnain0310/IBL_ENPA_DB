CREATE TABLE [dbo].[DimUserInfo_Test_20250411] (
  ...
  [IsSpecialCommittee] [char](1) NULL,
  [SpecialCommitteeAlt_Key] [int] NULL,
  [D2K_PSlt] [varchar](100) NULL,
  [IsGeographical] [varchar](1) NULL,
  [IsAdministrative] [varchar](1) NULL,
  [GeoLocation] [varchar](100) NULL,
  [GeoLocationCode] [varchar](100) NULL,
