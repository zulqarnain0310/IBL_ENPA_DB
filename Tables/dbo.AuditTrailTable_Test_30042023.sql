CREATE TABLE [dbo].[AuditTrailTable_Test_30042023] (
  [Report_Date] [date] NULL,
  [Insert_date] [datetime] NOT NULL,
  [Iteration_Cnt] [int] NULL,
  [IsUpload] [char](1) NULL,
  [UploadId] [int] NULL,
  [Accelerated Provision Amount] [decimal](16, 2) NOT NULL,
  [Accelerated Provision Percentage] [decimal](8, 5) NULL,
  [MOC reason] [varchar](80) NULL,
  [Name of Maker] [varchar](50) NULL,
  [Designation of Maker] [varchar](50) NULL,
  [Name of First Level Approver] [varchar](50) NULL,
  [Designation of First Level Approver] [varchar](50) NULL,
  [Date of First Level Approval] [smalldatetime] NULL,
  [Name of Second Level Approver] [varchar](50) NULL,
  [Designation of Second Level Approver] [varchar](50) NULL,
  [Date of Second Level Approval] [datetime] NULL,
