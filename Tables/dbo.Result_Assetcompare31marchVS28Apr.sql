CREATE TABLE [dbo].[Result_Assetcompare31marchVS28Apr] (
  [NCIF_Id_new] [varchar](100) NULL,
  [CustomerACID_new] [varchar](20) NULL,
  [NCIF_AssetClassAlt_Key_new] [smallint] NULL,
  [AC_AssetClassAlt_Key_new] [smallint] NULL,
  [SrcSysAlt_Key_new] [smallint] NULL,
  [NCIF_NPA_Date_new] [date] NULL,
  [AC_NPA_Date_new] [date] NULL,
