...
CREATE CLUSTERED INDEX [AdvSecurityValueDetail_IX]
  ON [CURDAT].[AdvSecurityValueDetail] ([ENTITYKEY])
  ON [PRIMARY]
GO

CREATE INDEX [AdvSecurityValueDetail_NONIX]
  ON [CURDAT].[AdvSecurityValueDetail] ([EffectiveFromTimeKey], [EffectiveToTimeKey], [SecurityEntityID], [ValuationExpiryDate])
