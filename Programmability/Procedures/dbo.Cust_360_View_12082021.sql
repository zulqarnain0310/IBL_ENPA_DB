...
GO
CREATE PROC [dbo].[Cust_360_View_12082021]
--DECLARE
 @TimeKey INT=24927
...
AS
	BEGIN
			...
			A.SanctionedLimit AS LimitSanctioned,
			A.Balance,
			...
			ISNULL(PNPA_Status,'N')AS PotentialNPA,
			--CONVERT(VARCHAR(10),PNPA_Date,103) AS PotentialNPA_Date ,
