...
GO
CREATE PROCEDURE [dbo].[AccMOCDownloadData]
	@Timekey INT
...
BEGIN
		...
		LEFT JOIN DimMocReason  R ON R.MocReasonAlt_Key= A.ACMOC_ReasonAlt_Key 
									AND R.MocReasonCategory='Account Reason'
									AND R.EffectiveToTimeKey=49999		--ADDED ON PROD 15042024 DUE TO DATA DUPLICACY ISSUE BY SHUBHAM KAMBLE
