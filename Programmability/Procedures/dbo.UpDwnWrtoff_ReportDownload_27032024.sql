...
CREATE PROCEDURE [dbo].[UpDwnWrtoff_ReportDownload_27032024]  

-- [dbo].[UpDwnWrtoff_ReportDownload]   'Shubham123','Write-Off Report','01/01/2020','01/01/2024'
				...
				--------------------------------------------------------------------------------------------------	
						...
						ELSE IF (@ReportType= 'Write-Off Report') 
							BEGIN
									...
									--Declare @InsertDate Date, @AsonDate date
									--Select @InsertDate = convert(date,InsertDate,103) from HistoryWrittenOffData
									DECLARE @AsonDate date
									Select @AsonDate = CONVERT(date,AsonDate,23) from  HistoryWrittenOffData
