...
CREATE PROCEDURE  [dbo].[ACNPAMOCStageDataInUp_09092021]
	@Timekey INT,
...
--								where A.EffectiveFromTimeKey=@TimeKey and A.EffectiveToTimeKey=@TimeKey
      ...
      ,FlgPNPA
					               ...
					               SELECT
                                                               ...
                                                               ,CASE WHEN (B.UNSERVED_INTEREST IS NULL) THEN A.UNSERVED_INTEREST ELSE  B.UNSERVED_INTEREST END as UNSERVED_INTEREST	
