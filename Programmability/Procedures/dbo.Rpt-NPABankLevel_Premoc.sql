...
-------Modified Data:- 14/06/2018
-------Report Name  :- BANK LEVEL NPA
-------*/

CREATE  proc [dbo].[Rpt-NPABankLevel_Premoc]
...
,CONVERT(VARCHAR(25),NCIF_NPA_Date,103)	                        AS 'NCIF_NPADate'
...
NCIF_AssetClassAlt_Key IN (2,3,4,5,6)
AND(NPA_IntegrationDetails.NCIF_AssetClassAlt_Key=@NCIFAssetClass OR @NCIFAssetClass=0)
