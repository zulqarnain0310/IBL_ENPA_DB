...
create PROCEDURE [dbo].[SP_MergeTempDataToMain_BKP_04022024]
AS
...
INSERT INTO [dbo].[NPA_IntegrationDetails]
		   ...
		   ,STD_ASSET_CAT_Alt_key -- ADDED ON 2024-01-24 FOR OBSERVATION OF DATA NOT GETTING CARRY FORWARD FOR THIS COLUMN BY ZAIN
		   )
SELECT      [NCIF_Id]
           ,[NCIF_Changed]
           ,[SrcSysAlt_Key]
