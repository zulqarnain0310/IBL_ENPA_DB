...
create PROC [dbo].[Assetclass_Reverse_Feed_29122021](@TimeKey INT,@IS_MOC CHAR(1)='N')
--@DATE VARCHAR(10)
AS
declare @DATE DATE
...
CustomerId Source_System_CIF,A.NCIF_Id Dedupe_ID_UCIC_Enterprise_CIF,b.SourceName
...
where ((isnull(AC_AssetClassAlt_Key,0)<>isnull(NCIF_AssetClassAlt_Key,0)
