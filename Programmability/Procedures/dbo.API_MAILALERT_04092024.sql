...
create PROCEDURE [dbo].[API_MAILALERT_04092024]--'IBL_ENPA_EXTRACTION STEP : Ganaseva_Provision_Stg_Daily' ,'Dear Ganaseva','Ganaseva ETL Staging Extraction was completed Successfully','Ganaseva ETL Staging Extraction was Failed',80,'RF'
...
EXEC sp_OAMethod @Object, 'Open', NULL, 'POST', 'https://ealert.indusind.com:1443/EmailApi/api/SendEmail', 'false'  ---- URL changed by Liyaqat on 20240824
...
Else 
		...
		EXEC sp_OAMethod @Object, 'SETRequestBody', null, 'Body', @2body
		EXEC sp_OAMethod @Object, 'Send', null, @2body
