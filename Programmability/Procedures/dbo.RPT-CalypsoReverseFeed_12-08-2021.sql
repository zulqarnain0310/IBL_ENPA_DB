...
----===============Calypso Reverse Feed=======================================-------
/*
CREATED BY  : VEDIKA
CREATED DATE: 19-06-2018
DESCRIPTION : Calypso REVERSE FEED
*/

CREATE PROC [dbo].[RPT-CalypsoReverseFeed_12-08-2021]
	@TimeKey AS INT,
	@COST AS FLOAT
AS
...
AND MOC_AssetClassAlt_Key IS NOT NULL and SrcSysAlt_Key=40 and MOC_Status='Y' AND MOC_AssetClassAlt_Key<>1
ORDER BY NCIF_Id
...
WHERE PerculatedAccounts.SrcSysAlt_Key=40
...
WHERE #MOCDATA.SrcSysAlt_Key=40	
AND PreProcessingFreeze='Y'
AND PreProcessingFreezeBy IS NOT NULL
AND PreProcessingFreezeDate IS NOT NULL
AND MOC_Freeze='Y'
