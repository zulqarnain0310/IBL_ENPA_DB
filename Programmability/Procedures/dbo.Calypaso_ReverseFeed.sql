...
CREATE PROC [dbo].[Calypaso_ReverseFeed]
...
a.CustomerId,a.CustomerName,a.NCIF_Id,D.AssetClassShortName,B.AC_AssetClassAlt_Key, B.AC_NPA_Date,b.NCIF_Id from #Temp a
