...
CREATE PROC [dbo].[Assetclass_Reverse_Feed](@TimeKey INT,@IS_MOC CHAR(1)='N')
...
/*** Single reversefeed after MOC Logic  ***/
	--IF Exists (Select 1 From ReverseFeedDetails_MOC) 
	--	Begin
	--		Exec [dbo].[Single_Reverse_Feed_PostMOC] @TimeKey
	--	End 
