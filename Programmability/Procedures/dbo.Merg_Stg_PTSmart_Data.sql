...
CREATE PROC [dbo].[Merg_Stg_PTSmart_Data]
WITH RECOMPILE
AS
...
SET [CustomerName]=FI.CustName,
	...
	,NI.NatureofClassification=FI.NATUREOFCLASSIFICATION--20231026 FOR COBORROWER BY ZAIN--ON PROD20240117
...
--20231026 FOR COBORROWER BY ZAIN--ON PROD20240117
UPDATE NI
...
/* COBORROWER CURNT INSERT FROM Stage Added ON 20231026 FOR COBORROWER BY ZAIN*/--ON PROD20240117
...
,NCIFID_COBORROWER
 )select CONVERT(DATE,Asondate,103),SourceSystemName_primaryaccount,NCIFID_primaryaccount,CustomerID_primaryaccount,CustomerAcID_primaryaccount,NCIFID_COBORROWER 
 FROM  IBL_ENPA_STGDB.dbo.PTSmart_Stg_COBORROWER 
