...
Create PROC [dbo].[Assetclass_Reverse_Feed_21012024](@TimeKey INT,@IS_MOC CHAR(1)='N')
--@DATE VARCHAR(10)
AS
declare @DATE DATE
select @DATE=Date from dbo.SysDataMatrix  where  TimeKey=@TimeKey
DECLARE @CUTOVERDATE DATE='2099-12-31'--changed on 20231021 by zain for finacle prolendz same source-- ON PROD 20240117
...
FROM NPA_IntegrationDetails_After_20240118Process
...
,ImpactingAccountNo		--20231025 ON UAT FOR COBO BY ZAIN -- ON PROD 20240117
,ImpactingSourceSystemName	--20231025 ON UAT FOR COBO BY ZAIN -- ON PROD 20240117
from [dbo].[NPA_IntegrationDetails_After_20240118Process] a
