...
CREATE PROCEDURE  [dbo].[WriteOffStageDataInUp]
	@Timekey INT,
...
BEGIN
	...
	BEGIN
		...
		BEGIN
				...
				SET @AsOnDate = (SELECT TOP 1 AsOnDate FROM WriteOffUpload_Stg WHERE filname=@FilePathUpload)
		END
