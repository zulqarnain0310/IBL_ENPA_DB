...
CREATE  proc [dbo].[Rpt-InvalidPAN_Others]
...
,ISNULL(CAST(isnull(NPA_IntegrationDetails.MOC_NPA_Date,NCIF_NPA_Date) AS varchar(25)),'NA')		AS 'NPADATE'
...
AND ( ((len(PAN)<10) AND ISNULL(PAN,'')<>'')
		...
		--AND NPA_IntegrationDetails.AC_AssetClassAlt_Key<>1
--AND NPA_IntegrationDetails.NCIF_Id='5659908'
