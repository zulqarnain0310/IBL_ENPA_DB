...
GO
CREATE PROCEDURE [dbo].[ValidateExcel_DataUpload_CustMOCUpload_07102021] 
@MenuID INT=10,  
...
--exec [dbo].[ValidateExcel_DataUpload_CustMOCUpload] @MenuID=N'97',@UserLoginId=N'IBLFM8839',@Timekey=N'26176',@filepath=N'Customer_MOC_Upload (1).xlsx'
