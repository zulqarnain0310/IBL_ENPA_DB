...
CREATE PROC [dbo].[Assetclass_Reverse_Feed_MOC_20250127](@TimeKey INT,@IS_MOC CHAR(1)='N') 
...
--Declare @Timekey as int=27272----MOC Month end of timekey
--Declare @Date as Date='2024-08-31'---- MOC date
--DeClare @IS_MOC as Char(1)='Y'
--DECLARE @CUTOVERDATE DATE='2024-01-24'--changed on 20231021 by zain for finacle prolendz same source-- ON PROD 20240126
...
and a.CustomerId=f.customerid and  
Cast(a.MOC_Date as date) in (CAST(getdate() as date)) ---–current date 
