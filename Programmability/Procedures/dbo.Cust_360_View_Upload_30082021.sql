...
--GO
CREATE Proc [dbo].[Cust_360_View_Upload_30082021]
...
--  ,@TimeKey INT = 25233
   ...
   ,c.value('./AccountNumber[1]','varchar(20)')CustomerACID
	...
	ISNULL(Cast(A.SubSegment as varchar(100)),'') AS SubSegment,
	...
	ISNULL(PNPA_Status,'N')AS [Potential NPA],
	ISNULL(CONVERT(VARCHAR(10),PNPA_Date,103),'') AS [Potential NPA Date],
	...
	ELSE 'N' END [Is Percolated],
	ISNULL(Cast(A.MaxDPD as varchar(100)),'') AS DPD,
