...
GO
create PROCEDURE  [dbo].[SecurityErosion_01072022]
(
@TimeKey int
)
AS
...
ANd NCIF_AssetClassAlt_Key not in (1,7) ANd SecuredFlag='Y' And IsFunded='Y'  
...
AND SecuredFlag='Y'
And IsFunded='Y'
AND NCIF_AssetClassAlt_Key NOT IN(@LOSS_Alt_Key)
