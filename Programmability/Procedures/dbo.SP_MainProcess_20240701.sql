...
Create PROCEDURE [dbo].[SP_MainProcess_20240701](@TimeKey Int, @IS_MOC CHAR(1)='N')
AS
BEGIN
...
EXEC [dbo].[COLLATERAL_DELINK_PROCESS] @TimeKey --added on 14 june 2024
...
EXEC [dbo].[COBORROWERREPORTGENERATION] @TimeKey	--step -8

EXEC [dbo].[PROVISION_COMPUTATION_REDUCTION] @TimeKey 		/*Need to add in job of mail processing add new step-9*/
