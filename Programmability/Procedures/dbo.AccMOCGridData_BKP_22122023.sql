...
GO
create PROCEDURE [dbo].[AccMOCGridData_BKP_22122023]
	 @Timekey INT
  ...
  --                              END ASC
   ...
   --                             END ASC
		...
		BEGIN
			...
			--,Sum(isnull(cast(ApprRV as decimal(22,2)),0))SecurityValue	/* (implemented at 04052023 at prod) */
			,Sum(isnull(cast(SecurityValue as decimal(22,2)),0))SecurityValue /* (implemented at 04052023 at prod) */		
