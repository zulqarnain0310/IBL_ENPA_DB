...
CREATE PROCEDURE [dbo].[ProvisionComputation_20231005] (@TimeKey Smallint,@IS_MOC CHAR(1)='N')
WITH RECOMPILE
AS
...
UPDATE  NID SET
 Provsecured=(CASE WHEN NID.NCIF_AssetClassAlt_Key=@SUB_Alt_Key AND (SELECT dbo.FullMonthsSeparation(@EXT_DATE, NID.NCIF_NPA_Date))<=3  THEN ISNULL(SecuredAmt,0)*DPP.upto_3_months 
										WHEN NID.NCIF_AssetClassAlt_Key=@SUB_Alt_Key AND ((SELECT dbo.FullMonthsSeparation(@EXT_DATE, NID.NCIF_NPA_Date))>3 AND (SELECT dbo.FullMonthsSeparation(@EXT_DATE, NID.NCIF_NPA_Date))<=6) THEN ISNULL(SecuredAmt,0)*DPP.From_4_months_upto_6_months 
										WHEN NID.NCIF_AssetClassAlt_Key=@SUB_Alt_Key AND ((SELECT dbo.FullMonthsSeparation(@EXT_DATE, NID.NCIF_NPA_Date))>6 AND (SELECT dbo.FullMonthsSeparation(@EXT_DATE, NID.NCIF_NPA_Date))<=9)   THEN ISNULL(SecuredAmt,0)*DPP.From_7_months_upto_9_months
										WHEN NID.NCIF_AssetClassAlt_Key=@SUB_Alt_Key AND ((SELECT dbo.FullMonthsSeparation(@EXT_DATE, NID.NCIF_NPA_Date))>9 AND (SELECT dbo.FullMonthsSeparation(@EXT_DATE, NID.NCIF_NPA_Date))<=12) THEN ISNULL(SecuredAmt,0)*DPP.From_10_months_upto_12_months
...
ProvUnsecured=(CASE WHEN NID.NCIF_AssetClassAlt_Key=@SUB_Alt_Key AND (SELECT dbo.FullMonthsSeparation(@EXT_DATE, NID.NCIF_NPA_Date))<=3 THEN ISNULL(UnSecuredAmt,0)*DPP.upto_3_months 
										WHEN NID.NCIF_AssetClassAlt_Key=@SUB_Alt_Key AND ((SELECT dbo.FullMonthsSeparation(@EXT_DATE, NID.NCIF_NPA_Date))>3 AND (SELECT dbo.FullMonthsSeparation(@EXT_DATE, NID.NCIF_NPA_Date))<=6) THEN ISNULL(UnSecuredAmt,0)*DPP.From_4_months_upto_6_months 
										WHEN NID.NCIF_AssetClassAlt_Key=@SUB_Alt_Key AND ((SELECT dbo.FullMonthsSeparation(@EXT_DATE, NID.NCIF_NPA_Date))>6 AND (SELECT dbo.FullMonthsSeparation(@EXT_DATE, NID.NCIF_NPA_Date))<=9)  THEN ISNULL(UnSecuredAmt,0)*DPP.From_7_months_upto_9_months
										WHEN NID.NCIF_AssetClassAlt_Key=@SUB_Alt_Key AND ((SELECT dbo.FullMonthsSeparation(@EXT_DATE, NID.NCIF_NPA_Date))>9 AND (SELECT dbo.FullMonthsSeparation(@EXT_DATE, NID.NCIF_NPA_Date))<=12) THEN ISNULL(UnSecuredAmt,0)*DPP.From_10_months_upto_12_months
...
TotalProvision=(CASE WHEN NID.NCIF_AssetClassAlt_Key=@SUB_Alt_Key AND (SELECT dbo.FullMonthsSeparation(@EXT_DATE, NID.NCIF_NPA_Date))<=3  THEN ISNULL(SecuredAmt,0)*DPP.upto_3_months 
										WHEN NID.NCIF_AssetClassAlt_Key=@SUB_Alt_Key AND ((SELECT dbo.FullMonthsSeparation(@EXT_DATE, NID.NCIF_NPA_Date))>3 AND (SELECT dbo.FullMonthsSeparation(@EXT_DATE, NID.NCIF_NPA_Date))<=6) THEN ISNULL(SecuredAmt,0)*DPP.From_4_months_upto_6_months 
										WHEN NID.NCIF_AssetClassAlt_Key=@SUB_Alt_Key AND ((SELECT dbo.FullMonthsSeparation(@EXT_DATE, NID.NCIF_NPA_Date))>6 AND (SELECT dbo.FullMonthsSeparation(@EXT_DATE, NID.NCIF_NPA_Date))<=9)   THEN ISNULL(SecuredAmt,0)*DPP.From_7_months_upto_9_months
										WHEN NID.NCIF_AssetClassAlt_Key=@SUB_Alt_Key AND ((SELECT dbo.FullMonthsSeparation(@EXT_DATE, NID.NCIF_NPA_Date))>9 AND (SELECT dbo.FullMonthsSeparation(@EXT_DATE, NID.NCIF_NPA_Date))<=12) THEN ISNULL(SecuredAmt,0)*DPP.From_10_months_upto_12_months
										WHEN NID.NCIF_AssetClassAlt_Key=@DB1_Alt_Key THEN ISNULL(SecuredAmt,0)*DPP.DOUBTFUL_1
										...
										END )
										+
										((CASE WHEN NID.NCIF_AssetClassAlt_Key=@SUB_Alt_Key AND (SELECT dbo.FullMonthsSeparation(@EXT_DATE, NID.NCIF_NPA_Date))<=3  THEN ISNULL(UnSecuredAmt,0)*DPP.upto_3_months 
										WHEN NID.NCIF_AssetClassAlt_Key=@SUB_Alt_Key AND ((SELECT dbo.FullMonthsSeparation(@EXT_DATE, NID.NCIF_NPA_Date))>3 AND (SELECT dbo.FullMonthsSeparation(@EXT_DATE, NID.NCIF_NPA_Date))<=6) THEN ISNULL(UnSecuredAmt,0)*DPP.From_4_months_upto_6_months 
										WHEN NID.NCIF_AssetClassAlt_Key=@SUB_Alt_Key AND ((SELECT dbo.FullMonthsSeparation(@EXT_DATE, NID.NCIF_NPA_Date))>6 AND (SELECT dbo.FullMonthsSeparation(@EXT_DATE, NID.NCIF_NPA_Date))<=9)   THEN ISNULL(UnSecuredAmt,0)*DPP.From_7_months_upto_9_months
										WHEN NID.NCIF_AssetClassAlt_Key=@SUB_Alt_Key AND ((SELECT dbo.FullMonthsSeparation(@EXT_DATE, NID.NCIF_NPA_Date))>9 AND (SELECT dbo.FullMonthsSeparation(@EXT_DATE, NID.NCIF_NPA_Date))<=12) THEN ISNULL(UnSecuredAmt,0)*DPP.From_10_months_upto_12_months
										WHEN NID.NCIF_AssetClassAlt_Key=@DB1_Alt_Key THEN ISNULL(UnSecuredAmt,0)*DPP.ProvisionUnSecured
