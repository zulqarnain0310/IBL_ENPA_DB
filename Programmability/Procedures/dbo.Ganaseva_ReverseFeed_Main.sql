...
--/****** Object:  StoredProcedure [dbo].[Ganaseva_ReverseFeed_Main]    Script Date: 1/12/2018 3:30:32 PM ******/
--SET ANSI_NULLS ON
--GO
--SET QUOTED_IDENTIFIER ON
--GO

CREATE  proc [dbo].[Ganaseva_ReverseFeed_Main]
@DATE		VARCHAR(10)
 AS

--DECLARE

--@DATE		VARCHAR(10)='31-03-2018'
