...
--------------------------------------------
	...
	IF (@OperationFlag=20)	---- SECOND LEVEL AUTHORIZE
	...
	BEGIN
		...
		UPDATE 
			...
			(
					...
					,SecurityValue
					,Action
					,AddProvision	--,AdditionalProvisionAmount is Replaced as AddProvision BY SATWAJI as on 10/12/2021
					,AccProvPer		--,AcceleratedProvisionPercentage is Replaced as AccProvPer BY SATWAJI as on 10/12/2021
					,SecuredFlag	--,SecuredStatus is Replaced as SecuredFlag BY SATWAJI as on 10/12/2021
					,AuthorisationStatus
					,EffectiveFromTimeKey
					,EffectiveToTimeKey
					,CreatedBy
