...
GO
CREATE PROCEDURE [dbo].[RestructureGapDataGridData]
	 @Timekey INT
...
BEGIN
	...
	BEGIN
		...
		FROM ExcelUploadHistory
		   WHERE (EffectiveFromTimeKey<=@Timekey AND EffectiveToTimeKey>=@Timekey) AND UploadType='Restructure GapData Upload'
