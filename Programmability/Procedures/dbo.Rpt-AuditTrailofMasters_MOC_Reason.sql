...
Report Name		:- Audit Trail of Masters (MOC Reason)
*/

CREATE  proc [dbo].[Rpt-AuditTrailofMasters_MOC_Reason]
...
SELECT
MocReasonAlt_Key	                                        AS [MOC Reason Code]
,MocReasonName                                              AS [MOC Reason Name]	
,MocReasonShortName                                         AS [MOC Reason ShortName]	
,MocReasonShortNameEnum	                                    AS [MOC Reason ShortNameEnum]
