...
CREATE PROCEDURE [dbo].[ValidateExcel_DataUpload_ProvisionPolicyUpload_20241111] 
@MenuID INT,  
...
------------------------Validations on SrNo-------------------------------------------------------------
 ...
 FROM UploadProvisionPolicy V  
 WHERE ISNULL(SrNo,'')  LIKE '%[,!@#$%^&*()_-+=/]%\' ESCAPE '\' --added by Mayuresh to consider % as string on 20241105
--LIKE '%[,!@#$%^&*()_-+=/]%'
 ...
 UPDATE UploadProvisionPolicy
	SET  
		...
		,Srnooferroneousrows=V.SrNo
 FROM UploadProvisionPolicy V  
 WHERE ISNULL(SourceSystem,'') LIKE '%[,!@#$%^&*()_-+=/]%\' ESCAPE '\' --added by Mayuresh to consider % as string on 20241105
 --LIKE'%[,!@#$%^&*()+=/\]%'
...
FROM UploadProvisionPolicy V  
 ...
 UPDATE UploadProvisionPolicy
	SET  
		...
		,Srnooferroneousrows=V.SrNo
 FROM UploadProvisionPolicy V  
 WHERE ISNULL(SchemeCode,'') LIKE '%[,!@#$%^&*()_-+=/]%\' ESCAPE '\' --added by Mayuresh to consider % as string on 20241105
 --LIKE'%[,!@#$%^&*()+=/\]%'
 ...
 WHERE V.Action NOT IN ('A','U','D') 
  ...
  UPDATE UploadProvisionPolicy
	SET  
		...
		,Srnooferroneousrows=V.SrNo							
 FROM UploadProvisionPolicy V  
 WHERE ISNULL(V.Action,'') LIKE '%[,!@#$%^&*()_-+=/]%\' ESCAPE '\' --added by Mayuresh to consider % as string on 20241105
 --LIKE'%[,!@#$%^&*()+=/\]%'
...
-------------validations on Provision percentage upto3months-------
 ...
 UPDATE UploadProvisionPolicy
	SET  
		...
		,Srnooferroneousrows=V.SrNo								  
 FROM UploadProvisionPolicy V  
 WHERE ISNULL(upto3months,'') LIKE '%[,!@#$%^&*()_-+=/]%\' ESCAPE '\' --added by Mayuresh to consider % as string on 20241105
...
-------------validations on Provision percentage From4monthsupto6months-------
 ...
 ISNUMERIC(From4monthsupto6months) LIKE '%^[0-9]%'
 PRINT 'INVALID' 
 ...
 UPDATE UploadProvisionPolicy
	SET  
		...
		,Srnooferroneousrows=V.SrNo								  
 FROM UploadProvisionPolicy V  
 WHERE ISNULL(From4monthsupto6months,'') LIKE '%[,!@#$%^&*()_-+=/]%\' ESCAPE '\' --added by Mayuresh to consider % as string on 20241105
 AND ISNUMERIC(From4monthsupto6months) LIKE '%^[0-9]%'
 ...
 UPDATE UploadProvisionPolicy
	SET  
		...
		,Srnooferroneousrows=V.SrNo								  
 FROM UploadProvisionPolicy V  
 WHERE ISNULL(From7monthsupto9months,'') LIKE '%[,!@#$%^&*()_-+=/]%\' ESCAPE '\' --added by Mayuresh to consider % as string on 20241105
...
-------------validations on Provision percentage From10monthsupto12months-------
 ...
 UPDATE UploadProvisionPolicy
	SET  
		...
		,Srnooferroneousrows=V.SrNo								  
 FROM UploadProvisionPolicy V  
 WHERE ISNULL(From10monthsupto12months,'') LIKE '%[,!@#$%^&*()_-+=/]%\' ESCAPE '\' --added by Mayuresh to consider % as string on 20241105
...
-------------validations on Provision percentage Doubtful1-------
 ...
 UPDATE UploadProvisionPolicy
	SET  
		...
		,Srnooferroneousrows=V.SrNo								  
 FROM UploadProvisionPolicy V  
 WHERE ISNULL(Doubtful1,'') LIKE '%[,!@#$%^&*()_-+=/]%\' ESCAPE '\' --added by Mayuresh to consider % as string on 20241105
...
-------------validations on Provision percentage Doubtful2-------
 ...
 UPDATE UploadProvisionPolicy
	SET  
		...
		,Srnooferroneousrows=V.SrNo								  
 FROM UploadProvisionPolicy V  
 WHERE ISNULL(Doubtful2,'') LIKE '%[,!@#$%^&*()_-+=/]%\' ESCAPE '\' --added by Mayuresh to consider % as string on 20241105
...
-------------validations on Provision percentage Doubtful3-------
 ...
 UPDATE UploadProvisionPolicy
	SET  
		...
		,Srnooferroneousrows=V.SrNo								  
 FROM UploadProvisionPolicy V  
 WHERE ISNULL(Doubtful3,'') LIKE '%[,!@#$%^&*()_-+=/]%\' ESCAPE '\' --added by Mayuresh to consider % as string on 20241105
...
-------------validations on Provision percentage Loss-------
 ...
 UPDATE UploadProvisionPolicy
	SET  
		...
		,Srnooferroneousrows=V.SrNo								  
 FROM UploadProvisionPolicy V  
 WHERE ISNULL(Loss,'') LIKE '%[,!@#$%^&*()_-+=/]%\' ESCAPE '\' --added by Mayuresh to consider % as string on 20241105
...
-------------validations on Provision percentage ProvisionUnSecured-------
 ...
 UPDATE UploadProvisionPolicy
	SET  
		...
		,Srnooferroneousrows=V.SrNo								  
 FROM UploadProvisionPolicy V  
 WHERE ISNULL(ProvisionUnSecured,'') LIKE '%[,!@#$%^&*()_-+=/]%\' ESCAPE '\' --added by Mayuresh to consider % as string on 20241105
