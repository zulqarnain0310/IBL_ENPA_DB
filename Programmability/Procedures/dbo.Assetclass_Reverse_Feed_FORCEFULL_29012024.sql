...
CREATE PROC [dbo].[Assetclass_Reverse_Feed_FORCEFULL_29012024](@TimeKey INT,@IS_MOC CHAR(1)='N')
--@DATE VARCHAR(10)
AS
declare @DATE DATE
...
FROM NPA_INTEGRATIONDETAILS_FORCEFULL_RF_29012024
...
,ImpactingAccountNo		--20231025 ON UAT FOR COBO BY ZAIN -- ON PROD 20240117
,ImpactingSourceSystemName	--20231025 ON UAT FOR COBO BY ZAIN -- ON PROD 20240117
from [dbo].[NPA_INTEGRATIONDETAILS_FORCEFULL_RF_29012024] a
...
--			OR ISNULL(AC_NPA_Date,'1900-01-01')<>ISNULL(NCIF_NPA_Date,'1900-01-01')
			(ISNULL(Retail_Corpo,'N')='Y' AND @TimeKey=26557) -----  Added on 17092022 for identifying force asset class update
